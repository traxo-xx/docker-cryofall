#!/bin/bash
# Original script source: https://gist.github.com/renzok/29c9e5744f1dffa392cf
...
chown -R ${USER_ID}:${USER_GID} /CryoFall/

exec su - "${USER}" -c "cd /CryoFall/Binaries/Server/; dotnet CryoFall_Server.dll loadOrNew"